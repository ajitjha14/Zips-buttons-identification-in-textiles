...
images = glob.glob('/home/amir/Desktop/test/Taken_pictures/*.jpg')
...
if len(objpoints) > 0 and len(imgpoints) > 0 and gray is not None:
    ...
    np.savez('/home/amir/Desktop/Realsense_L515/C.npz', mtx=mtx, dist=dist, rvecs=rvecs, tvecs=tvecs)
else:
...
with np.load('/home/amir/Desktop/Realsense_L515/C.npz') as X:
...
images = glob.glob('/home/amir/Desktop/Realsense_L515/*.jpg')
